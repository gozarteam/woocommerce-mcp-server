...
// Your huge switch-case handler simplified for example
...
const server = new McpServer({
  name: "WooCommerceMCPServer",
  version: "1.0.0",
});

// Register a single tool that accepts JSON-RPC style calls
server.tool(
  "call",
  {
    method: z.string().describe("API method to call"),
    params: z.record(z.any()).optional().describe("Parameters for the method"),
  },
  async ({ method, params }) => {
    try {
